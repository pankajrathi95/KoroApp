...
export class SimpleSurvey extends Component {
    ...
    render() {
        ...
        const followUpQuestion = survey[currentQuestion].followUpQuestion;// && this.state.answers[currentQuestion - 1].value.value == "1";
        if (followUpQuestion != undefined && followUpQuestion && this.state.answers[currentQuestion - 1].value.value == "0") {
            currentQuestion++;
            let {currentQuestionIndex} = this.state;
            currentQuestionIndex++;
            this.setState({currentQuestionIndex});
